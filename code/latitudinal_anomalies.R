...
zone_data %>%
  ggplot(aes(x=t_diff, xend = t_diff, y=zone_position-0.25, yend=zone_position+0.25))+
  ...
  labs(x= "Temperature anomaly (\u00B0C)",
       y = NULL,
       title = "Variation in Annual Temperature \nAnomaly by Latitude (1880-2022)",
...
ggsave("figures/latitudinal_anomalies.png", width=4, height=3, units="in")
